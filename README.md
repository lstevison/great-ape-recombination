...
>Options: --positions --filtered-sites
  ...
  1F. Rate Estimation
    ...
    i. Convert PHASE output to VCF: Using initial minor allele filtered VCF file and PHASE output file, a VCF was generated using 'PHASE2VCF.pl' which can be found in the 'vcf-conversion-tools' repository.
    ii. Break chromosomes into 4000 SNP segments: Each block was further reduced to 4k SNP segments for rate estimation using 'CreateChrBedFromVCF.pl' found in the 'vcf-conversion-tools' repository.
